...
const CurrencySelector = ({ route, navigation }: { route: any, navigation: any}) => {
    ...
    React.useEffect(() => {
        navigation.setOptions(({
            ...
            headerSearchBarOptions: {
                onChangeText: (event: any) => handleSearch(event.nativeEvent.text),
    ...
    const CurrencyView = ({ currencies }: { currencies: any}) => {
        return (
    ...
    const handleSearch = (text: string) => {
        ...
        const filtered = [...data.currency, ...data.crypto].filter(currency => {
    ...
    function contains(currency: any, query: string) {
